...
import sfa.config.kitti_config_2sides as cnf
...
class SFA3D():
    def __init__(self):
        ...
        self.velo_sub = rospy.Subscriber("/kitti/velo/pointcloud", PointCloud2, self.velo_callback, queue_size=1, buff_size=2**24) # "/kitti/velo/pointcloud"
        print("Started Node")
