...
def on_scan(scan):
    ...
    print('numpy : %.4f sec'%(time.time()-start_time))
...
if __name__ == '__main__':
    ...
    pub = rospy.Publisher('detected_objects', DetectedObjectArray, queue_size=1)
    rospy.Subscriber("/filtered_velodyne", PointCloud2, on_scan) # "/kitti/velo/pointcloud"
    rospy.spin()
