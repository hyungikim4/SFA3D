...
sys.path.append('./')
sys.path.append(
    '/home/usrg/catkin_ws/src/eurecar_ros/perception/environmental_perception/lidar/SFA3D')
...
from sfa.utils.demo_utils_1sides import parse_demo_configs, do_detect, download_and_unzip, write_credit, do_detect_2sides
from sfa.data_process.veloster_1sides_bev_utils import makeBEVMap
...
class SFA3D():
    def __init__(self):
        ...
        configs.pretrained_path = '/home/usrg/catkin_ws/src/eurecar_ros/perception/environmental_perception/lidar/SFA3D/Model_veloster_416_416_2_epoch_750.pth'
